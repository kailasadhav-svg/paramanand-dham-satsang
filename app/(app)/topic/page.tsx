...
export default function TopicPage() {
  ...
  useEffect(() => {
    ...
    void api<{ meeting: Meeting; topic_locked?: boolean; chintan_count?: number }>(
  ...
  const topicEditable = canEditTopic && !topicLocked;
    ...
    <div className="space-y-4">
      ...
      <label className="block text-xs font-semibold text-temple-muted">
        ...
        <input
          ...
          className="mt-1 w-full rounded-xl bg-white px-3 py-2.5 ring-1 ring-saffron-200"
          placeholder="नाव"
          disabled={isVahak || !canEditTopic || topicLocked}
        />
      </label>
      <label className="block text-xs font-semibold text-temple-muted">
        {CHINTAN_LABEL}
        <textarea
          ...
          disabled={!canEditTopic || topicLocked}
          className="mt-1 w-full rounded-xl bg-white px-3 py-2.5 ring-1 ring-saffron-200"
        />
      </label>
      {canEditTopic && !topicLocked ? (
